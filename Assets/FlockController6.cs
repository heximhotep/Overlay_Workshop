...
public class FlockController6 : MonoBehaviour
{
    const int AGENT_NUM = 500;
    public Mesh model;
    ...
    ComputeBuffer jointDataBuf,
        ...
        debugBuf, flockDataBuf, parAddBuf;
    ...
    void InitializeAgentBuffer()
    {
        ...
        {
            agents[i] = new Agent(transform.position + Random.insideUnitSphere * 45f, Random.insideUnitSphere * maxSpeed / 10);
        }
        ...
        int kid = flockComputer.FindKernel("TimeStep");
        flockComputer.SetBuffer(kid, "AgentBuf", agentBuf);
    }
    ...
    {
        int flockKID = flockComputer.FindKernel("TimeStep");
        ...
        commander.DispatchCompute(flockComputer, flockKID, AGENT_NUM, 1, 1);
    ...
    void InitializeBuffers()
    {
        ...
        parAddBuf = new ComputeBuffer(AGENT_NUM * AGENT_NUM, sizeof(float) * 4);
        flockComputer.SetBuffer(flockKID, "ParAddBuf", parAddBuf);
        flockDataBuf = new ComputeBuffer(AGENT_NUM, sizeof(float) * 12);
        flockComputer.SetBuffer(flockKID, "FDataBuf", flockDataBuf);
        instanceXBuf = new ComputeBuffer(AGENT_NUM, sizeof(float) * 16);
        flockComputer.SetBuffer(flockKID, "XFormBuf", instanceXBuf);
    ...
    void Start()
    {
        ...
        flockComputer = Resources.Load<ComputeShader>("FlockingComputer5");
